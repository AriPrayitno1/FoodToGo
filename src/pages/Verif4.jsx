        ...
        <div className='flex flex-col items-center'>
          <div className='bg-white w-1/2 py-8 px-12 rounded-md'>
            <div className='text-center mb-8'>
              <h1 className='text-xl font-bold'>Informasi Bank</h1>
            </div>
            <div className='mb-8'>
              <h1 className='text-lg font-bold mb-4'>Unggah buku tabungan Anda</h1>  
            ...
            <div>
              <h1 className='text-lg font-bold mb-4'>Unggah foto Anda bersama KTP</h1>  
                <div class="flex items-center justify-center w-full">
                    <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
